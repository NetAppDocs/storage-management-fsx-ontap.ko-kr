...
== NetApp Workload Factory를 사용하여 파일 시스템을 관리합니다

NetApp Console 시스템 페이지에서 FSx for ONTAP 시스템을 열면 NetApp Workload Factory로 이동합니다. NetApp Workload Factory는 업계 모범 사례를 활용하여 Amazon FSx for NetApp ONTAP을 사용해 주요 워크로드를 계획, 프로비저닝 및 운영하는 지능형 최적화 및 자동화 서비스입니다.

https://docs.netapp.com/us-en/workload-fsx-ontap/index.html["NetApp Workload Factory를 사용하여 파일 시스템을 관리하는 방법을 알아보세요"^]
