...
---
= NetApp Console에서 FSx for ONTAP 데이터 복제
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* FSx for ONTAP과 온프레미스 ONTAP 또는 Cloud Volumes ONTAP 간에 데이터를 복제하려면 파일 시스템에 연결할 수 있는 Console 에이전트를 선택하거나 파일 시스템을 입력하여 링크를 연결해야 합니다.link:https://docs.netapp.com/us-en/workload-fsx-ontap/links-overview.html["링크 사용에 대해 알아보세요"^]
