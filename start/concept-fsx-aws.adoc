...
NetApp Console 이나 NetApp 스토리지 솔루션 및 서비스에 대한 일반 및 기술 지원 문제의 경우 NetApp 조직 수준 일련 번호를 사용하여 NetApp 지원 티켓을 열 수 있습니다.  당신은 필요합니다link:https://docs.netapp.com/us-en/console-fsx-ontap/support/task-support-registration.html["NetApp 조직 등록"^] 지원을 활성화합니다.
